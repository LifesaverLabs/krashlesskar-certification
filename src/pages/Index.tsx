          ...
          <div className="p-6 rounded-xl bg-secondary/50 border border-border mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-background/50 border border-border">
                ...
                <p className="text-muted-foreground">
                  Additionally, <strong className="text-foreground">car software makers, car manufacturers, and national states</strong> can accelerate the end of automobile insurance systems entirely by taking on <strong className="text-foreground">tail risk</strong>—simplifying the system and freeing buyers from needing to carry car insurance policies altogether. That, however, is ultimately up to the <strong className="text-foreground">car makers, waqf stewards, covenant holders, and/or the public</strong> to decide—whether through the invisible Hippocratic hand, ascertainable nomic democratic mandate, or legal regulation.
                </p>
              </div>
            </div>
          </div>
